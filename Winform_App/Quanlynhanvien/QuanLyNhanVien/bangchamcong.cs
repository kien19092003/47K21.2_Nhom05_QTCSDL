...
namespace QuanLyNhanVien
{
    public partial class bangchamcong : Form
    {
        ...
        private void bt_sua_Click(object sender, EventArgs e)
        {
            try
            {
                    string sql2 = "update BANGCHAMCONG set MaCC='" + macc_txt.Text + "', MaNV=N'" + manv_txt.Text + "', NgayCong='" + ngay_txt.Text + "', SoGio='" + sogio_txt.Text + "', MaCong='" + macong_txt.Text + "' where MaCC ='"+macc_txt.Text+"'";
                    if (macc_txt.Text == "")
                    {
